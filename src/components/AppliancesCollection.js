...
function ApplianceCollection() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const productIds = [
          "64b169f00bc2e1df48d096b6",
          "64b17034739b5f40257224bc",
          "64b165e30bc2e1df48d096ac",
          "64b165090bc2e1df48d096a8",
        ];
...
export default ApplianceCollection;
